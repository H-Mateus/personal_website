...
![Cute red panda](cute-red-panda-40.jpg){fig-alt="Cute red panda" width=50%}
...
I can also include some relative links to, for example, tell you to check out this [other section of my site](/about)!
...
::: {.callout-note}
Now that I've migrated my site to use Quarto instead of RMarkdown, the relative links now work how you'd expect, which is very nice!
:::
