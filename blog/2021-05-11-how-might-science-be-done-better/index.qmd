...
```{r exit, echo=FALSE, fig.cap='(ref:exit)', out.width='50%'}
...
```{r newspaper, echo=FALSE, fig.cap='(ref:newspaper)', out.width="60%"}
...
```{r typewriter, echo=FALSE, fig.cap='(ref:typewriter)'}
...
```{r sharing, echo=FALSE, fig.cap='(ref:sharing)', fig.align='center'}
...
```{r coins, echo=FALSE, fig.cap='(ref:coins)'}
...
```{r head, fig.cap="(ref:head)", out.width="60%"}
