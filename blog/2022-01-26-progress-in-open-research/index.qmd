...
(ref:pci-journals1) Image credit: [**PCI**](https://peercommunityin.org/)

```{r pci-journals1, echo=FALSE, fig.cap='(ref:pci-journals1)', fig.align='center'}
...
(ref:pci-journals) Image credit: [PCI](https://peercommunityin.org/pci-friendly-journals/)

```{r, label='pci-journals', fig.cap='(ref:pci-journals)', fig.align='center'}
