...
- <i class="fa fa-link"></i> [h-mateus.github.io](https://h-mateus.github.io/)
...
- Experienced in statistical analysis, statistical learning models, optimization methods and bioinformatics.

- Full experience with next generation sequencing data analysis.

- Highly skilled in R, Bash, Python, LaTeX
...
- Began instial work towards building a next-generation cochlea implant
