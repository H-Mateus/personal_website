...
This post relates to the [poster](sci_proteomics_pagedown_2020-06-08.html) I presented at the virtual Joint CDT conference of 2020.
...
However, even at my young age, I've seen many a scientist who think this only applies to their experiments.
...
Sure you can write some like "A T-test was performed" in your method but there's nothing that tells me precisely how you went from the raw data your experiments generate to the graphs and tables I see in your paper.
...
It's for these reasons that I'm currently looking into redoing the processing of the raw data in R.
