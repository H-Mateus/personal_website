...
Proper here meaning I'm first author which, if you aren't familiar with the fun(?) nuances of academia, is the only authorship that's worth a damn (other than last author, which is also good).
...
(ref:caption-example) Artists rendition of me pretending to work. Except not really. Image credit: [**iStock**](https://www.istockphoto.com/)
...
(ref:dunno) What does it even mean to "know" something in these crazy times anyway...? Image credit: [**Giphy**](https://giphy.com/gifs/idk-shrug-shrugging-K6VhXtbgCXqQU)

```{r, fig.cap='(ref:dunno)', out.width="500px", fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/K6VhXtbgCXqQU/giphy.gif")
```
...
We're interested in routine bloods because we suspected they could provide valuable insight into outcomes at no cost to the healthcare provider, as the data had already been collected anyway.
...
(ref:spinal-cord) A nice cartoon of the spinal cord. Image credit: [**Nature Reviews**](https://www.nature.com/articles/nrdp201718/figures/1)

```{r, fig.cap='(ref:spinal-cord)', out.width="500px", fig.align='center'}
knitr::include_graphics("spinal_cord.jpg")
```
...
To give you a sense of scale, we used around 80 patients in our first preliminary paper and around 430 in this follow paper.
...
(ref:happy-rabbit) One happy looking rabbit. I wonder what drugs they gave it... Image credit: [**Giphy**](https://giphy.com/gifs/happy-smile-smiling-1136UBdSNn6Bu8)

```{r, fig.cap='(ref:happy-rabbit)', out.width="500px", fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/1136UBdSNn6Bu8/giphy.gif")
```

Both papers suggest that several blood markers associated with liver function add value to predictions of outcome.
This has peaked out interest and we hope to further investigate this link in subsequent work.
...
(ref:celebrate) \\( ͡> ‿‿ ͡<)/ Image credit: [**Giphy**](https://giphy.com/gifs/Ge86XF8AVY1KE/links)

```{r, fig.cap='(ref:celebrate)', out.width="500px", fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/Ge86XF8AVY1KE/giphy.gif")
```
